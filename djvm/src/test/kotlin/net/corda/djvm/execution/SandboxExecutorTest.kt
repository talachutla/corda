...
class SandboxExecutorTest : TestBase() {
    ...
    @Test
    fun `can load and execute contract`() = parentedSandbox(
    ...
    class TestObjectHashCode : Function<Int, Int> {
        override fun apply(input: Int): Int {
            ...
            require(hash1 == hash2)
            return Object().hashCode() - obj.hashCode()
        }
    }
    ...
    @Test
    fun `cannot execute runnable that catches ThreadDeath`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
    ...
    @Test
    fun `cannot execute runnable that catches ThresholdViolationError`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
    ...
    @Test
    fun `cannot execute runnable that catches RuleViolationError`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
    ...
    @Test
    fun `can catch Throwable`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
        val contractExecutor = DeterministicSandboxExecutor<Int, Int>(configuration)
    ...
    @Test
    fun `can catch Error`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
        val contractExecutor = DeterministicSandboxExecutor<Int, Int>(configuration)
    ...
    @Test
    fun `cannot catch ThreadDeath`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
        val contractExecutor = DeterministicSandboxExecutor<Int, Int>(configuration)
        assertThatExceptionOfType(SandboxException::class.java)
    ...
    @Test
    fun `cannot catch stack-overflow error`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
        val contractExecutor = DeterministicSandboxExecutor<Int, Int>(configuration)
        assertThatExceptionOfType(SandboxException::class.java)
    ...
    @Test
    fun `cannot catch out-of-memory error`() = parentedSandbox(pinnedClasses = setOf(Utilities::class.java)) {
        val contractExecutor = DeterministicSandboxExecutor<Int, Int>(configuration)
        assertThatExceptionOfType(SandboxException::class.java)
